...
// bool (*matcher[3])(uint32_t, uint32_t);   //moved to common.cpp. Making
// function static was cringe imo. static bool (*matcher[3])(uint32_t, uint32_t)
// = {exact, matchID, matchFunction};
