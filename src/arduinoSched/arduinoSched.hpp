...
//Optionally pass via platformio build flags if you have concerns about number of tasks (not enough space, or not enough tasks)
...
public:
    ...
    //Other stuff: 
    int scheduleOneTimeTask(void (*function)(void), int16_t delay);     //use the returned int to reference this task in runOneTimeTask
