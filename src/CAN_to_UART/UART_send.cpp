...
// ---------- Framing helpers ----------
#define debugPrintMode 0    //Optionally print as ascii hex instead of binary (for reading UART_send outputs on platformio moniter. Telem dashboard is set to read binary, not ASCII Hex)
